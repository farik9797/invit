...
export const HERO_SLIDES: HeroSlide[] = [
  {
    id: 'slide-1',
    title: 'Ленты EUROBAND — собственное производство в Минске',
    subtitle: 'Высокоадгезионные пароизоляционные, гидроизоляционные и бутиловые ленты для монтажа окон и фасадов.',
    highlight: 'Порезка любых ширин от 10 до 1500 мм под ваши размеры за 24 часа!',
    image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&q=80&w=1200',
    categoryLink: 'montazhnye-lenty',
    features: ['Сертификация СТБ и ГОСТ', 'Заводская гарантия 10 лет', 'Прямые оптовые цены']
  },
  {
    id: 'slide-2',
...
export const CERTIFICATES: CertificateItem[] = [
  ...
  {
    id: 'cert-3',
    title: 'Сертификат продукции собственного производства БелТПП №2025/11',
    type: 'Сертификат БелТПП',
