...
export const QuoteFormSection: React.FC<QuoteFormSectionProps> = ({ initialNote = '' }) => {
  ...
  return (
    <section id="contacts" className="py-14 bg-ink text-white relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3 pt-2 text-xs sm:text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-ink/40">Закрепленный специалист по объектам и опту</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-ink/40">Минск, ТЦ Сеница (пересечение МКАД)</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-ink/40">Индивидуальные условия оплаты для строительных трестов</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-white/5 rounded-xl border border-white/15 space-y-2">
              <span className="block text-xs text-ink/45 font-mono uppercase">Прямой номер отдела продаж:</span>
              <a
          ...
          {/* Right Form Column */}
          <div className="lg:col-span-7 bg-white text-ink rounded-xl p-6 sm:p-8 shadow-lg border border-line">
            {submitted ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-2.5 bg-surface-soft border border-line rounded-lg text-ink font-medium focus:ring-2 focus:ring-brand-blue focus:outline-none"
                    />
                  </div>
