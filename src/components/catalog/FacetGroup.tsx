 ...
 *
 * Брендов в каталоге шестьдесят, поэтому внутри раскрытого блока показываем
 * восемь самых частых, а длинные списки получают собственное поле поиска:
 * искать «Макиту» прокруткой на телефоне — занятие на полминуты.
 */
