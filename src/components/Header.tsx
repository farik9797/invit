        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-xl mx-2 hidden md:block">
            <div className="relative flex items-center">
              <input
                type="text"
                placeholder="Поиск по названию, артикулу (напр. EB-IN-70) или категории..."
                value={searchQuery}
                onChange={(e) => {
                ...
                className="w-full pl-10 pr-12 py-2.5 bg-slate-50 text-slate-800 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B5FA5] focus:bg-white transition-all shadow-inner"
              />
              <Search className="w-4 h-4 text-slate-400 absolute left-3.5" />
              <button
                type="button"
                className="absolute right-1.5 bg-[#0B5FA5] hover:bg-[#1A6DB5] text-white text-xs font-semibold px-3 py-1.5 rounded transition-colors"
              >
                Найти
              </button>
            </div>
