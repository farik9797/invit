    ...
    <div className="relative max-w-[1340px] mx-auto px-5 py-16 sm:py-24 flex lg:justify-end">
      <div className="bg-ink/95 backdrop-blur-sm p-8 sm:p-12 max-w-xl">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3">
          <Link
            to={paths.contacts}
            className="inline-flex justify-center items-center bg-brand-green hover:bg-brand-green-hover text-white text-sm font-semibold px-7 py-3.5 transition-colors"
          >
            Связаться с нами
          </Link>
          <a
            href="tel:+375296444979"
            className="inline-flex justify-center items-center border border-white/25 hover:bg-white/10 text-white text-sm font-semibold px-7 py-3.5 transition-colors whitespace-nowrap"
          >
            +375 (29) 644-49-79
          </a>
        </div>
