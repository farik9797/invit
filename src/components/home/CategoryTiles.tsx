  ...
  <section className="py-16 sm:py-20 bg-surface">
    <div className="max-w-[1340px] mx-auto px-5">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-10">
        ...
        <p className="text-sm text-ink/60 max-w-md lg:text-right">
        ...
        {TAPES.map((tile) => (
          ...
          >
            ...
            <div className="p-4 border-t border-line">
              <h3 className="text-sm font-semibold text-ink leading-snug group-hover:text-brand-blue transition-colors hyphens-auto break-words">
                {tile.name}
              </h3>
              <span className="mt-1 block text-xs text-ink/50">{tile.count} позиций</span>
            </div>
          </Link>
        ))}
      </RevealGroup>
      ...
      <div className="mt-12 pt-8 border-t border-line">
        <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2 mb-5">
          <h3 className="text-base font-semibold text-ink">Сопутствующие товары</h3>
