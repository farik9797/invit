...
export const NotFoundPage: React.FC = () => (
  <section className="max-w-[1340px] mx-auto px-5 py-24 text-center space-y-5">
    ...
    <h1 className="text-2xl font-bold text-brand-navy tracking-tight">Страница не найдена</h1>
    ...
    <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
      ...
      <Link
        to={paths.home}
        className="border border-line hover:bg-surface-soft text-brand-navy font-bold text-sm px-6 py-3 rounded-xl transition-colors"
      >
        На главную
      </Link>
    </div>
