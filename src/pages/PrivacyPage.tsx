    ...
    <section className="bg-white">
      <div className={`${WRAP} py-10 sm:py-14`}>
        <Section title="Кто обрабатывает данные">
          <p>
            Оператор — общество с ограниченной ответственностью «ИНВИТ», УНП 600500616,
            Минская обл., г. Солигорск, ул. Строителей, 30, каб. 101. Связаться по вопросам о данных:{' '}
            <a
        ...
        <Section title="Аналитики у нас нет, но есть карты Яндекса">
          <p>
            Сам сайт не подключён к системам веб-аналитики и рекламным пикселям, своих
            счётчиков не ставит и не отслеживает вас на других сайтах.
          </p>
          <p>
            Исключение — карты на страницах «Контакты» и «О компании»: там встроен виджет
            Яндекс.Карт. Пока карта на экране, браузер обращается к серверам Яндекса, и
            Яндекс может сохранять свои cookie по своим правилам. Мы этих данных не
            получаем и в своих целях не используем.
          </p>
        </Section>
