    ...
    <section className="bg-white">
      <div className={`${WRAP} py-10 sm:py-14`}>
        ...
        <Section title="Аналитики и рекламных счётчиков нет">
          ...
          <p>
            Единственный сторонний сервис — карты на страницах «Контакты» и «О компании».
            Пока карта на экране, браузер подгружает её изображение с openstreetmap.org;
            рекламных счётчиков и cookie там нет.
          </p>
        </Section>
