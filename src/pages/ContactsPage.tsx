...
const REQUISITES = [
  ...
  { label: 'ОКПО', value: '29040090' },
  {
    label: 'Юридический адрес',
    value: 'РБ, 223710, Минская обл., г. Солигорск, ул. Строителей, 30, каб. 101'
  },
  {
    label: 'Минское подразделение',
    value: 'РБ, 223056, Минский р-н, Сеницкий сельсовет, 84, каб. 9'
  },
  { label: 'IBAN', value: 'BY41PJCB30121005041000000933' },
  { label: 'Банк', value: 'Доп. офис 115/4 «Приорбанк» ОАО, BIC PJCBBY2X' }
];
